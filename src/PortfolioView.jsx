...
export default function PortfolioView({ investmentId, investmentName, onBack, showToast }) {
  ...
  const getSector = (symbol) => {
    const sectors = {
      'NVDA': 'שבבים', 'AMD': 'שבבים', 'INTC': 'שבבים', 'TSM': 'שבבים', 'AVGO': 'שבבים', 'QCOM': 'שבבים', 'ASML': 'שבבים', 'NVDL': 'שבבים',
      ...
      'PATH': 'תוכנה', 'MNDY': 'תוכנה', 'SHOP': 'תוכנה', 'UBER': 'תוכנה',
      'JPM': 'פיננסים', 'BAC': 'פיננסים', 'V': 'פיננסים', 'MA': 'פיננסים', 'PYPL': 'פיננסים', 'WFC': 'פיננסים', 'GS': 'פיננסים', 'SOFI': 'פיננסים', 'PGY': 'פיננסים',
      'JNJ': 'בריאות', 'UNH': 'בריאות', 'PFE': 'בריאות', 'ABBV': 'בריאות', 'LLY': 'בריאות', 'MRK': 'בריאות', 'MRNA': 'בריאות',
      'XOM': 'אנרגיה', 'CVX': 'אנרגיה', 'SHEL': 'אנרגיה',
      'SPY': 'מדדים', 'QQQ': 'מדדים', 'DIA': 'מדדים', 'VOO': 'מדדים', 'IVV': 'מדדים', 'VTI': 'מדדים', 'VT': 'מדדים', '1183441': 'מדדים', '1159250': 'מדדים', 'IWM': 'מדדים', 'VIXY': 'מדדים',
